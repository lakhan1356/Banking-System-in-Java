	...
	class register implements ActionListener, ItemListener{
		public void actionPerformed(ActionEvent e){
			...
			try {
				...
				String qq = "insert into logindetails(userid,pass,mobile,emailid,ini_balance,gender,acc_type,question,answer,Status) values('"+username+"','"+pass+"','"+mobile+"','"+emailid+"','"+ini_balance+"','"+gender+"','"+acc_type+"','"+question+"','"+answer+"','Approved')";
